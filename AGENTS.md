...
| Generate Marp slides from changelogs | `generate_changelog_slides.prompt.md` |
...
## 4. Slide Generation (Marp)

Presentation slides are generated on demand by Copilot Chat from changelog data.

- Slide decks: `./slides/YYYY-MM-DD-<descriptive-name>.md`
- Data sources: `changelogs/_ai/*.ai.json` (structured) + `changelogs/*.md` (detail)
- Prompt file: `.github/prompts/generate_changelog_slides.prompt.md`
- Export: `npx @marp-team/marp-cli slides/<deck>.md` (HTML/PDF/PPTX)
