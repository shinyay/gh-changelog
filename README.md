...
### AI sidecar generation

AI sidecar JSON files are generated by Copilot Chat via the prompt files under `.github/prompts/`. Run the pipeline prompt to generate sidecars, then validate them.
