...
fetched_at: "2026-02-07T16:09:15.559461Z"
---
...
- GitHub Actions runner scale set client The GitHub Actions runner scale set client is now available in public preview.
- Allowed actions settings now available for all plan types Action allowlisting is now available across all GitHub plans, bringing security controls to Free, Team, and Enterprise customers.
- Windows Server 2025 with Visual Studio 2026 image now available for GitHub-hosted runners A new Windows runner image with Visual Studio 2026 is now available in public preview.
- For additional information on the available windows runner images, visit our doucmentation . macOS 26 Intel image now available for GitHub-hosted runners We’ve released the GitHub Actions macOS 26 Intel runner image in public preview for larger runners, providing the latest macOS and Xcode tooling for Intel-based workflows.

## Caveats / Limitations
- Important : You’ll manage all infrastructure setup, provisioning logic, and scaling strategies.
- Editor’s note (February 5, 2026): Corrected a typo in the date that mistakenly said March 2025.
...
## [GitHub Actions runner scale set client](https://github.blog/changelog/feed/#github-actions-runner-scale-set-client)
...
* **Full provisioning control**: You define how runners are created, scaled, and destroyed based on your specific requirements.
* **Native multi\-label support**: Assign multiple labels to each scale set, optimizing resources for multiple build types.
* **Agentic scenario support**: Supports agentic workflows, including GitHub [Copilot coding agent](https://docs.github.com/enterprise-cloud@latest/copilot/how-tos/use-copilot-agents/coding-agent/customize-the-agent-environment?utm_source=changelog-docs-cca-selfhosted-runners&utm_medium=changelog&utm_campaign=universe25#about-customizing-copilot-coding-agents-development-environment).
* **Real\-time telemetry**: Monitor job execution and runner performance with built\-in metrics.
...
### [Relationship to Actions Runner Controller](https://github.blog/changelog/feed/#relationship-to-actions-runner-controller)


The Runner Scale Set Client isn’t a replacement for Actions Runner Controller (ARC), which remains a reference implementation of the scale set APIs and the recommended Kubernetes solution for autoscaling runners. Instead, the client is a new tool for interfacing with same scale set APIs for building custom autoscaling solutions outside of Kubernetes. Multi\-label support will also be made available for ARC with the 0\.14\.0, which will be available in March 2026—see [the issue for adding this support](https://github.com/github/roadmap/issues/1195).
...
The [GitHub Actions Runner Scale Set Client](https://github.com/actions/scaleset) is fully open source and available for you to explore the source code and adapt the implementation to your specific infrastructure needs. You can also visit the [GitHub Actions Runner Scale Set Client documentation](https://docs.github.com/actions/hosting-your-own-runners) for additional information.


Try out [GitHub Actions Runner Scale Set Client](https://github.com/actions/scaleset), join the [community discussion](https://gh.io/to-community-186265), and share your feedback!


## [Allowed actions settings now available for all plan types](https://github.blog/changelog/feed/#allowed-actions-settings-now-available-for-all-plan-types)


Action allowlisting is now available across all GitHub plans, bringing security controls to Free, Team, and Enterprise customers. You can define exactly which actions and reusable workflows run in your repositories to enforce least privilege principles, protect against potentially compromised actions, and maintain consistent policies.


Learn more in the [managing GitHub Actions permissions documentation](https://docs.github.com/repositories/managing-your-repositorys-settings-and-features/enabling-features-for-your-repository/managing-github-actions-settings-for-a-repository#allowing-select-actions-and-reusable-workflows-to-run), which includes step\-by\-step configuration examples and security best practices.


## [Windows Server 2025 with Visual Studio 2026 image now available for GitHub\-hosted runners](https://github.blog/changelog/feed/#windows-server-2025-with-visual-studio-2026-image-now-available-for-github-hosted-runners)
...
To use the the new runner image, update the `runs-on:` target in your YAML workflow file to `windows-2025-vs2026`. For additional information on the available windows runner images, visit [our doucmentation](https://docs.github.com/actions/reference/runners/github-hosted-runners?versionId=free-pro-team%40latest&productId=actions&restPage=concepts%2Crunners%2Cgithub-hosted-runners).


## [macOS 26 Intel image now available for GitHub\-hosted runners](https://github.blog/changelog/feed/#macos-26-intel-image-now-available-for-github-hosted-runners)


We’ve released the GitHub Actions macOS 26 Intel runner image in public preview for larger runners, providing the latest macOS and Xcode tooling for Intel\-based workflows. To use it, update the `runs-on:` target in your YAML workflow file to `macos-26-large`. For complete details on available software and versions, visit the [macOS runner images documentation](https://docs.github.com/actions/reference/runners/larger-runners#available-macos-larger-runners-and-labels).
