...
- This feature is currently in public preview and available to Copilot Enterprise and Copilot Pro+ users.
...
To use Copilot change groups, opt in to the [new “Files changed” preview](https://github.blog/changelog/2025-06-26-improved-pull-request-files-changed-experience-now-in-public-preview/?utm_source=changelog-docs-grouping-changes-in-pr&utm_medium=changelog&utm_campaign=universe25) page by selecting **Try the new experience** in the top\-right corner of the **Files changed** tab.


### [Feedback](#feedback)


We want to hear from you! Visit the [GitHub community discussion](https://gh.io/change-group-feedback?utm_source=changelog-feedback-grouping-changes-in-pr&utm_medium=changelog&utm_campaign=universe25).
