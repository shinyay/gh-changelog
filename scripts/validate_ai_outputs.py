#!/usr/bin/env python3
"""Validate AI sidecar JSON outputs against the schema."""
...
def main() -> int:
    ...
    schema_path = os.path.join(root, "schemas", "changelog_ai_analysis.schema.json")
    schema = load_json(schema_path)

    validator = Draft202012Validator(schema)

    ai_dir = os.path.join(root, "changelogs", "_ai")
