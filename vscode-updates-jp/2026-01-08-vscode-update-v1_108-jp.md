---
title: "2025年12月（バージョン 1.108）"
lang: "ja"
date: "2026-01-08"
version_ref: "v1_108"
download_version: "1.108.2"
source_url: "https://code.visualstudio.com/updates/v1_108"
source_markdown_url: "https://raw.githubusercontent.com/microsoft/vscode-docs/main/release-notes/v1_108.md"
fetched_at: "2026-02-05T08:27:34.266136Z"
---
...
このリリースは“年末の整備/磨き込み”として位置づけられつつ、エージェント運用のカスタマイズ（Agent Skills）やセッション UX、ターミナルの安全性/衛生面、アクセシビリティなど、実運用の品質向上が目立ちます。

- Agent Skills（実験的）: 必要時に読み込める「指示/スクリプト/リソース」をフォルダーとしてまとめる仕組み。
- セッション/履歴: セッション一覧やクイックピックの整備、復元挙動の見直しなど。
- ターミナル: 自動承認ルール/履歴汚染防止/IntelliSense の既定挙動など、安全性と使い勝手を調整。
- アクセシビリティ: Accessible View のストリーミングなど。
...
_(Download links are available on the official release page: https://code.visualstudio.com/updates/v1_108)_

---

Welcome to the December 2025 release of Visual Studio Code.

![Placeholder for release image](https://code.visualstudio.com/assets/updates/1_108/release-highlights.webp)
...
## Agents
Agent Skills（実験的）やセッション運用改善など、エージェント利用時の“再利用可能な作法”と“運用のしやすさ”が強化されています。
...
![Screenshot of the Agent Sessions view showing changed files and associated pull requests for sessions.](https://code.visualstudio.com/assets/updates/1_108/agentsessions-trimmed.png)
...
## Chat
チャット/セッションの切り替えや復元など、運用 UX の改善点がまとめられています（詳細は上流リリースノート参照）。
...
![Screenshot of the chat Quick Pick showing a list of agent sessions.](https://code.visualstudio.com/assets/updates/1_108/agent-picker.png)
...
![Screenshot of the chat title control.](https://code.visualstudio.com/assets/updates/1_108/agent-title.png)
...
![Auto approval denied by rule will show after a denial](https://code.visualstudio.com/assets/updates/1_108/terminal-tool-deny.png)
...
![Screenshot of the Allow dropdown in the Terminal tool showing options to allow commands for the current session or workspace.](https://code.visualstudio.com/assets/updates/1_108/terminal-tool-allow-dropdown.png)
...
## Accessibility
アクセシビリティ関連では、応答のストリーミングやノイズ低減などの改善点がまとめられています（詳細は上流リリースノート参照）。
...
## Editor Experience
設定プロファイル取り込みなど、ワークベンチ体験の改善点がまとめられています（詳細は上流リリースノート参照）。
...
![Screenshot of the Copy Breadcrumbs Path command.](https://code.visualstudio.com/assets/updates/1_108/breadcrumbs_copy_path.png)
...
## Code Editing
スニペット変換など、編集支援の改善点がまとめられています（詳細は上流リリースノート参照）。
...
## Source Control
Git blame など、ソース管理関連の改善点がまとめられています（詳細は上流リリースノート参照）。
...
![Screenshot showing the Worktrees node in the Source Control Repositories view with a list of worktrees](https://code.visualstudio.com/assets/updates/1_108/repository-explorer-worktrees.png)
...
## Terminal
ターミナルツールの安全性（履歴への追加抑止など）と IntelliSense の既定挙動変更（手動トリガー寄り）を含む改善点がまとめられています（詳細は上流リリースノート参照）。
...
![Screenshot of the suggest status bar showing buttons to configure selection mode and whether to show suggestions on type.](https://code.visualstudio.com/assets/updates/1_108/terminal-suggest.png)
...
![Screenshot of the hint that shows when opening a terminal now explains how to trigger "show suggestions".](https://code.visualstudio.com/assets/updates/1_108/terminal-initial-hint.png)
...
![Screenshot of the complete set of about 800 custom glyphs now rendered without needing a font.](https://code.visualstudio.com/assets/updates/1_108/terminal-custom-glyphs.png)
...
![Screenshot of the terminal curly underline which is a lot more vivid now and has a zigzag look like in the editor.](https://code.visualstudio.com/assets/updates/1_108/terminal-curly-underline.png)
...
![Screenshot of the overlay that appears in the middle of the terminal with the current columns and rows when a terminal resize happens.](https://code.visualstudio.com/assets/updates/1_108/terminal-resize-overlay.png)
...
![Graph showing the overall issues for all VS Code managed repositories.](https://code.visualstudio.com/assets/updates/1_108/combined-graph.png)

![Graph showing the total amount of open issues closed during housekeeping.](https://code.visualstudio.com/assets/updates/1_108/issue-reduction.png)

![Graph showing the total amount of unknown issues triaged during housekeeping (excluding closed issues).](https://code.visualstudio.com/assets/updates/1_108/unknown-reduction.png)
...
![Issue graph for microsoft/vscode.](https://code.visualstudio.com/assets/updates/1_108/vscode-graph.png)
...
![Issue graph for microsoft/vscode-copilot-release.](https://code.visualstudio.com/assets/updates/1_108/vscode-copilot-release-graph.png)
...
![Graph showing historical issue data for microsoft/vscode from 2018 to present.](https://code.visualstudio.com/assets/updates/1_108/historical-vscode-graph.png)
