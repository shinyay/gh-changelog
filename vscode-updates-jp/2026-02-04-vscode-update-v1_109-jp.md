...
_(Download links are available on the official release page: https://code.visualstudio.com/updates/v1_109)_
...
![Screenshot showing the context window control and the hover message showing a breakdown per category.](https://code.visualstudio.com/assets/updates/1_109/context-window-widget.png)
...
<video src="https://code.visualstudio.com/assets/updates/1_109/inline-chat.mp4" title="Video showing inline chat affordance and contextual input." autoplay loop controls muted></video>
...
![Screenshot showing the language model picker with a hover flyout describing the currently selected model, Claude Opus.](https://code.visualstudio.com/assets/updates/1_109/model-picker.png)
...
* **Syntax highlighting for inline Node, Python, and Ruby**
    ...
    ![Screenshot showing inline Python calls presenting just the Python code to make it easier to review.](https://code.visualstudio.com/assets/updates/1_109/terminal-python-presenter.png)

* **Working directory**

    ![Screenshot showing the directory the command will run in, called out in the title after "within".](https://code.visualstudio.com/assets/updates/1_109/terminal-tool-cd-presentation.png)

* **Description of the command's intent**

    ![Screenshot showing the goal of the command when hovering, explaining the why instead of just the what.](https://code.visualstudio.com/assets/updates/1_109/terminal-tool-goal.png)
...
<video src="https://code.visualstudio.com/assets/updates/1_109/embedded-terminal-streaming.mp4" title="Video showing terminal output auto-expanding for long-running commands." autoplay loop controls muted></video>
...
<video src="https://code.visualstudio.com/assets/updates/1_109/embedded-terminal-input.mp4" title="Video showing typing input directly into an embedded terminal in chat." autoplay loop controls muted></video>
...
![Screenshot showing delete icon on Hidden terminals entry in the tabs list.](https://code.visualstudio.com/assets/updates/1_109/delete-hidden-terminals.png)
...
![Screenshot showing the new experimental VS Code Dark theme.](https://code.visualstudio.com/assets/updates/1_109/vscode-dark-experimental-theme.webp)

**VS Code Light (Experimental)**:

![Screenshot showing the new experimental VS Code Light theme.](https://code.visualstudio.com/assets/updates/1_109/vscode-light-experimental-theme.webp)
...
![Screenshot showing continuing a session in a different environment using the session type picker.](https://code.visualstudio.com/assets/updates/1_109/session-type-picker-continue.png)
...
<video src="https://code.visualstudio.com/assets/updates/1_109/agent-sessions-viewer.mp4" title="Video showing agent sessions in the Chat view." autoplay loop controls muted></video>
...
![Screenshot showing agent status indicator with attention needed count.](https://code.visualstudio.com/assets/updates/1_109/agent-status-indicator/input-needed.png)
...
![Screenshot showing two active subagents in chat with an active spinner next to them.](https://code.visualstudio.com/assets/updates/1_109/subagents.png)
...
* **Model selection for cloud agents**
    ...
    ![Screenshot showing cloud agent model selection picker in chat input.](https://code.visualstudio.com/assets/updates/1_109/cloud-agent/model-picker.png)
...
* **Custom agents for cloud agents**
    ...
    ![Screenshot showing custom agent selection picker in chat input.](https://code.visualstudio.com/assets/updates/1_109/cloud-agent/custom-agent.png)
...
* **Multi-root workspace and empty workspace improvements**
    ...
    ![Screenshot showing multi-root support in chat input.](https://code.visualstudio.com/assets/updates/1_109/cloud-agent/cloud-repository-picker.png)
...
* **Custom agents for background agents**
    ...
    ![Screenshot showing custom agent selection picker in background chat input.](https://code.visualstudio.com/assets/updates/1_109/background-agent-custom-agent.png)

* **Attach images as context**

    ![Screenshot showing image support in background chat input.](https://code.visualstudio.com/assets/updates/1_109/background-agent-image-support.png)
...
* **Multi-root workspace improvements**
    ...
    ![Screenshot showing multi-root support in background chat input.](https://code.visualstudio.com/assets/updates/1_109/background-agent-multi-root.png)
...
![Screenshot showing the Agent Sessions Welcome Page with recent sessions, quick actions, and an embedded chat widget.](https://code.visualstudio.com/assets/updates/1_109/agent-sessions-welcome-page.png)
...
![Screenshot showing the configure skills option in the Chat view.](https://code.visualstudio.com/assets/updates/1_109/configure-skills.png)
...
![Screenshot showing the Chat Customization Diagnostics view with loaded agents, prompts, instructions, and skills.](https://code.visualstudio.com/assets/updates/1_109/chat-customization-diagnostics.png)
...
* **Multiple configurations per provider**:  create multiple configurations for the same model provider, each with a different API key. This is useful for separating personal and work accounts, or using different API keys for different projects. For example, you might have one Gemini configuration with your personal API key and another with your team's API key.
    ...
    ![Screenshot showing multiple Gemini groups with different configurations.](https://code.visualstudio.com/assets/updates/1_109/chat-lm-editor-groups.png)
...
* **Configuring models from Azure provider**: when configuring Azure models, VS Code opens the `chatLanguageModels.json` configuration file and inserts a snippet template. This snippet includes the required properties such as model ID, name, endpoint URL, and token limits. You can then fill in the values for each model you want to add.
    ...
    <video src="https://code.visualstudio.com/assets/updates/1_109/chat-lm-editor-azure-config.mp4" title="Video showing Azure model configuration in the Language Models editor." autoplay loop controls muted></video>
...
* **Additional UI improvements**: several usability improvements, such as keyboard access for toggling model visibility, context menu actions, and multi-select for bulk actions.
    ...
    <video src="https://code.visualstudio.com/assets/updates/1_109/chat-lm-editor-improv.mp4" title="Video showing additional UI improvements in the Language Models editor." autoplay loop controls muted></video>
...
* **Language-model configuration file**: model configurations are now stored in a dedicated `chatLanguageModels.json` file. Open this file directly by selecting the file icon in the top-right corner of the Language Models editor. This makes it easy to view, edit, or share your model configurations.
    ...
    ![Screenshot showing the file icon in the Language Models editor to open the configuration file.](https://code.visualstudio.com/assets/updates/1_109/language-models-editor-config-file.png)
...
* **Default model for plan implementation (Experimental)**
    ...
    ![Screenshot showing the Settings editor with the github.copilot.chat.implementAgent.model setting.](https://code.visualstudio.com/assets/updates/1_109/implement-agent-model-setting.png)
...
* **Default model for inline chat**
    ...
    ![Screenshot showing the Settings editor with the inlineChat.defaultModel setting and a dropdown list of available language models.](https://code.visualstudio.com/assets/updates/1_109/inline-chat-default-model.png)
...
* **Specify language model for agent handoffs**
    ...
    ![Screenshot showing an agent handoff configuration in an agent file with the model parameter specified.](https://code.visualstudio.com/assets/updates/1_109/handoff-model-parameter.png)
...
![Diagram showing an orchestration system with multiple specialized agents collaborating to complete a task.](https://code.visualstudio.com/assets/updates/1_109/agent-orchestration-diagram.png)
...
![Screenshot showing Claude agent next to Local, Background & Cloud in the session target picker.](https://code.visualstudio.com/assets/updates/1_109/claude-agent.png)
...
![Screenshot showing an interactive flame graph visualization rendered by an MCP App.](https://code.visualstudio.com/assets/updates/1_109/mcp-apps-flame-graph.png)
...
![Screenshot showing the memory tool in chat with a list of stored memories and a request to always ask clarifying questions when in doubt.](https://code.visualstudio.com/assets/updates/1_109/copilot-memory-tool.png)
...
![Screenshot showing a prompt asking the user to allow or deny access to read files outside the workspace.](https://code.visualstudio.com/assets/updates/1_109/agent-external-file-access.png)
...
* You can now manually push a terminal tool call to the background, freeing up the agent to continue with other work.
    ...
    ![Screenshot showing the button with the play icon that allows the agent to continue with that command running in the background.](https://code.visualstudio.com/assets/updates/1_109/terminal-tool-continue-in-background.png)
...
<video src="https://code.visualstudio.com/assets/updates/1_109/editor-double-click.mp4" title="Video showing new double-click behavior in the editor." autoplay loop controls muted></video>
...
<video src="https://code.visualstudio.com/assets/updates/1_109/post-rename.mp4" title="Video showing post rename suggestion in the editor." autoplay loop controls muted></video>
...
![Screenshot showing ghost text with a dotted underline for short suggestions.](https://code.visualstudio.com/assets/updates/1_109/ghost-text-underline.png)
...
<video src="https://code.visualstudio.com/assets/updates/1_109/integrated-browser.mp4" title="Video showing the integrated browser features." autoplay loop controls muted></video>
...
![Screenshot showing the macOS DMG image mounted.](https://code.visualstudio.com/assets/updates/1_109/macos-dmg-installer.png)
...
![Screenshot showing VS Code in the Windows 11 context menu.](https://code.visualstudio.com/assets/updates/1_109/win11-context-menu.png)
...
![Screenshot showing the deprecated Copilot extension and the active Copilot Chat extension.](https://code.visualstudio.com/assets/updates/1_109/copilot-extension-deprecated.png)
