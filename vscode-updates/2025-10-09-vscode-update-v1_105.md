...
**Update**: Check out the announcements from [VS Code at GitHub Universe](#vs-code-at-github-universe).

_(Download links are available on the official release page: https://code.visualstudio.com/updates/v1_105)_
...
![GitHub Universe 2025 banner image.](https://code.visualstudio.com/assets/updates/1_105/universe-banner.png)
...
![Screenshot of the Chat view with the Plan agent selected and a prompt to create an implementation plan for a feature.](https://code.visualstudio.com/assets/updates/1_105/plan-agent-sample.png)
...
![Screenshot of the Agent Sessions view showing an OpenAI Codex session.](https://code.visualstudio.com/assets/updates/1_105/agent-sessions-codex.png)
...
![Screenshot of the Agent Sessions view showing a Copilot CLI session.](https://code.visualstudio.com/assets/updates/1_105/agent-sessions-copilot-cli.png)
